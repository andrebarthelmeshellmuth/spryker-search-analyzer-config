...
return RectorConfig::configure()
    ...
    ->withSkip([
        ...
        // regeneration would just revert it). Same exemption class as the sibling packages' *Bridge.php
        // skip; kept here even though this package has no Bridge yet, for parity when one is added.
